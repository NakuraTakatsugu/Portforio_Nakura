    ...
    <section class="section about-this-site">
      <div class="inner">
        ...
        <div class="contents-wrap js-fadeUpTrigger">
          <p class="text">
            私がエンジニアとしてのスキルを磨く為に作成したWEBサイトやページについて、使用したスキルも併せて紹介しています。当サイト(NAKUPO!!)についても、要件定義から、デザインカンプの作成、コーディングまで、全て自分で作成しました。下には自分の自己紹介文も載っていますのでどうぞ最後までお楽しみください！
          </p>
        </div>
      </div>
    </section>
      ...
      <div class="inner">
        ...
        <div class="contents-wrap js-fadeUpTrigger">
          <div class="introduce">
            ...
            <p class="detail">
              小・中学生向けプログラミング教師と家庭教師を兼業する中で、エンジニアになりたい子ども達にとって本当に役に立つ知識を伝える為にエンジニアになることを決意。実務に沿ったカリキュラムで学ぶため、株式会社PIXEL HEARTSへ入社。現在はSES業務の傍ら、カリキュラム最終課題に向けて日々勉強中。
            </p>
          </div>
          <div class="avatar">
            <img
